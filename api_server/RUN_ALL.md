# Complete Pipeline: Extract → Name → Context

This is the complete 3-step workflow to process your memories from raw videos/images to named, contextualized data.
